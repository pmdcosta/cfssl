...
kubectl create secret generic rabbitmq-ssl-server-dev --from-file=development/rabbitmq/server.pem --from-file=development/rabbitmq/server-key.pem
...
## RabbitMQ server credentials
kubectl create secret generic rabbitmq-ssl-server --from-file=production/rabbitmq/server.pem --from-file=production/rabbitmq/server-key.pem
## RabbitMQ client credentials
